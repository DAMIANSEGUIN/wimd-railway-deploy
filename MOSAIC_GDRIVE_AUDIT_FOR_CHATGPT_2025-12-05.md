...
## 📋 CHATGPT: FILES YOU MUST READ FOR DIAGNOSTICS

This is your priority reading list, organized by importance.
...
### ⭐ TIER 3: MVP IMPLEMENTATION (Critical Context)
...
**Note**: Additional MVP implementation files may be in local directory but not yet uploaded to GDrive.

---

### ⭐ TIER 4: ARCHITECTURE & STRUCTURE
...
### ⭐ TIER 6: CANONICAL DEPLOYMENT SCRIPTS

**Note**: Shell scripts may not be in GDrive. Key scripts to know about:

26. **scripts/deploy.sh** - Main deployment wrapper (canonical)
27. **scripts/verify_live_deployment.sh** - Verify live production
28. **scripts/push.sh** - Git push wrapper with verification
29. **scripts/pre_push_verification.sh** - Pre-push sanity checks
...
│   ├── HANDOFF_TO_GPT51_CODEX_DAY1_COMPLETE.md ✅
│   └── HANDOFF_TO_GEMINI_DAY1_COMPLETE.md ✅
├── Planning/
│   ├── Archive_20251026/ (archived booking docs)
│   ├── NAR_Archive/ (archived NAR tasks)
...
### 2. Schema Version Mismatch (RESOLVED)

**Was**: `/config` endpoint returned `"v1"` but code is v2
**Status**: Resolved per TEAM_PLAYBOOK.md Section 2
...
## 📋 DIAGNOSTIC PROTOCOL FOR CHATGPT
...
4. SELF_DIAGNOSTIC_FRAMEWORK.md (architecture-specific)

### Step 2: Understand Current State (15 min)

Read:
5. MOSAIC_MVP_IMPLEMENTATION/GEMINI_DAY_1_REVIEW.md (blockers status)
6. CLEANUP_SUMMARY_2025-12-05.md (what changed today)
7. RECURRING_BLOCKERS.md (common patterns)

### Step 3: Review Architecture (15 min)

Read:
8. CLAUDE.md (system overview)
9. MOSAIC_ARCHITECTURE.md (technical architecture)
10. DEPLOYMENT_TRUTH.md (deployment procedures)
...
- **Environment Drift**: Are local vs. production environments in sync?
- **Preflight Validation**: Are deployment scripts running pre-checks?
...
**Error Handling**:
10. Are errors logged explicitly (not swallowed)?
11. Are fallback behaviors defined for all critical paths?
12. Is health monitoring detecting issues?

**Session Management**:
13. Are agents saving state properly between sessions?
14. Are handoffs including all necessary context?
15. Is there audit trail of what each agent did?

---

## 📁 FILES NOT YET IN GDRIVE (May Need Upload)
...
- SESSION_HANDOFF_2025-12-03.md
- QUICK_STATUS.md
- USER_EXPERIENCE_MAP.md
- AI_TEAM_METHODOLOGY.md
- MOSAIC_DIAG_INTEGRATION.md
- NOTE_FOR_CLAUDE.md
- NOTE_FOR_CODEX.md
...
- USER_INTERRUPT_PROTOCOL.md
- BOOKING_SYSTEM_FUTURE_MODULE.md (renamed today)

**Recommendation**: User should verify which files are in GDrive and upload missing critical files.
...
4. Begin systematic diagnosis per protocol in TROUBLESHOOTING_CHECKLIST.md
...
**Alternative**: Share individual file links for Tier 1-3 files if folder sharing not working.

---

**END OF GDRIVE AUDIT FOR CHATGPT**

**Created**: 2025-12-05
**Purpose**: Enable ChatGPT diagnostic review with GDrive file access
**Total Key Files**: 34 prioritized files across 7 tiers
**GDrive Status**: Core files uploaded, some may need verification
