# Documentation Discipline - Quick Reference
...
All agents must now update documentation before declaring tasks complete and log changes in audit/handoff files.
...
- Update all impacted documentation
- Summarize changes in handoff/audit log

**Before deployment:**

- Update related documentation and audit logs
- Ensure UI/code changes have documentation

**After deployment:**

- Log deployment outcome in audit log
- Update deployment docs with timestamp and BUILD_ID

**Cursor will flag documentation drift in reviews.**

---

**Questions?** See full acknowledgment document or protocol files above.
