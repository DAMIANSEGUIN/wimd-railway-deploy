...
from ..._base_client import DEFAULT_MAX_RETRIES, AsyncAPIClient, BaseClient, SyncAPIClient
...
from ..._utils import asyncify, is_dict, is_given
...
def _prepare_options(
    ...
    if (
        options.url in {"/v1/messages/count_tokens", "/v1/messages/count_tokens?beta=true"}
