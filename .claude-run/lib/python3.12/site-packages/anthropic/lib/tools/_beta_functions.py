...
from ...types.tool_param import InputSchema, ToolParam
...
class BaseFunctionTool(Generic[CallableT]):
    ...
    def _create_schema_from_function(self) -> InputSchema:
        ...
        class CustomGenerateJsonSchema(GenerateJsonSchema):
            ...
            def __call__(self, *_args: Any, **_kwds: Any) -> CustomGenerateJsonSchema:
                return self
        ...
        schema_generator = CustomGenerateJsonSchema(
            func=self.func, parsed_docstring=self._parsed_docstring
        )
    ...
    *,
    ...
    if func is not None:
        ...
        return BetaFunctionTool(
            func=func, name=name, description=description, input_schema=input_schema
        )
