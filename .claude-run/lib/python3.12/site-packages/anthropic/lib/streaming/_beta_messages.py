...
from ...types.beta import BetaContentBlock, BetaMessage, BetaRawMessageStreamEvent
...
def build_events(
    *,
    ...
    if event.type == "message_start" or event.type == "message_delta":
        events_to_fire.append(event)
    elif event.type == "message_stop":
        events_to_fire.append(
            build(BetaMessageStopEvent, type="message_stop", message=message_snapshot)
        )
        ...
        if event.delta.type == "text_delta":
            ...
            if isinstance(content, TRACKS_TOOL_INPUT):
                ...
                if json_buf:
                    try:
                        anthropic_beta = (
                            request_headers.get("anthropic-beta", "") if request_headers else ""
                        )
