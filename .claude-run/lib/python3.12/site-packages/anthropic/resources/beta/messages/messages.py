...
from ....lib.streaming import BetaAsyncMessageStreamManager, BetaMessageStreamManager
...
from ....lib.tools._beta_functions import BetaAsyncRunnableTool, BetaRunnableTool
        ...
        *,
        ...
        extra_headers = {
            **strip_not_given(
                {
                    "anthropic-beta": (
                        ",".join(str(e) for e in betas) if is_given(betas) else not_given
                    )
                }
            ),
            **(extra_headers or {}),
