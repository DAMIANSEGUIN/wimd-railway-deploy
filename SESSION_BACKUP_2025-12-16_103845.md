...
chmod +x backups/20251031_173812_railway_deployment_failure/setup_claude_runner.sh
chmod +x scripts/sync_to_gdrive_oneshot.sh
chmod +x setup_claude_runner_no_conda.sh
chmod +x backups/20251031_173812_railway_deployment_failure/setup_claude_runner_no_conda.sh
