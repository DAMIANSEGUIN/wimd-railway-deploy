...
**Migration:** Railway → Render (completed 2026-01-05)
...
**Migration Reasons:**
1. Railway health check failures (continuous issues despite extended timeouts)
...
```bash
OPENAI_API_KEY=sk-***  # From Railway
CLAUDE_API_KEY=sk-ant-***  # From Railway
